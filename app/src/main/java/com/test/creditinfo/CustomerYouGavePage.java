    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youGaveSaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("phonenumber",phonenumber);
                startActivity(intent);
                String message = "custname"+amount;
                smsManager.sendTextMessage(phonenumber, "", message, null,
                        null);
                Toast.makeText(CustomerYouGavePage.this, "Message Delivered", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
